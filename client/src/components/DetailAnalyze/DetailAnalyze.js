        ...
        <div className={s.analyzeWrap}>
          ...
          <div className={s.AnalyzeContainer}>
            <div className={s.analyzeMenualGuide}>
              <h1>GUIDE</h1>
              <p>※ 데이터들의 측정기준 기간은 한분기입니다.<br/><br/>
              ※ 해당 페이지에서 동은 앞서 사용자가 앞서서 선택한 강남구 내 행정동을 의미합니다.<br/><br/>
              ※ 해당 페이지에서 상권은 앞서 선택한 행정동 내에 존재하는 상권들입니다.<br/></p>
            </div>

            <div className={s.analyzeMenualTerms}>
              <h1>용어 정리</h1>
              <div className={s.analyzeMenualTermsContent}>
                <div className={s.termsTitle}>
                  <h4>집객시설</h4>
                </div>
                <div className={s.termsContent}>
                  <p>공원, 대형 사우나, 관광지, 대형 백화점/아울렛 등 대규모의 인구유입을 유도하는 시설</p>
                </div>
              </div>
              ...
              <div className={s.analyzeMenualTermsContent}>
                ...
                <div className={s.termsContent}>
                  <p>서울시가 2018년 KT와 합동으로 인구 추계를한 인구모델로 조사시점에서 개인이 위치한 지역을 기반으로 집계한 인구데이터 →
                   해당 지역의 거주자 뿐만 아니라 등교, 출근, 병원방문 등의 이유로 조사시점에 해당지역에 있는 모든 인구를 집계한 모델이다.</p>
                </div>
              </div>
              ...
              <div className={s.analyzeMenualTermsContent}>
                ...
                <div className={s.termsContent}>
                  <p>해당 지역에 주거지를 두고 거주하는 인구를 의미한다, 상주인구는 주간에는 특정 이유로 다른 지역으로 이동해 있을 가능성이 있다.</p>
                </div>
              </div>
