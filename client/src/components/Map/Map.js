...
const Map = (props) => {
  ...
  function DrawPolygon() {
    ...
    data.forEach((coordinate) => {
      ...
      if (coordinate.geometry.type === "MultiPolygon") {
        displayArea(coordinate.geometry.coordinates,true)
        console.log(coordinate.geometry.coordinates)
      }
      else {
        displayArea(coordinate.geometry.coordinates, false)
      }
    })
  }
  ...
  function makeMultiPolygon(coordinates){
    ...
    coordinates.forEach((val2)=>{
      var coordinates2 =[];

      val2.forEach((coordinate)=>{
  ...
  function displayArea(coordinates, multi){
